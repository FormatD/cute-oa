...
export type Budget = { id: string; tenantId: string; departmentId: string; expenseCategory?: string | null; projectId?: string | null; year: number; month: number; allocatedAmount: number; committedAmount: number; actualAmount: number; availableAmount: number; status: BudgetStatus; concurrencyVersion: number; createdBy: string; createdAt: string; updatedAt: string }
export type CreateBudgetRequest = { departmentId: string; year: number; month: number; expenseCategory?: string | null; projectId?: string | null; allocatedAmount: number }
export type AdjustBudgetRequest = { amount: number; reason: string }
export type BudgetCheckRequest = { departmentId: string; expenseCategory?: string | null; amount: number; year?: number | null; month?: number | null }
export type BudgetCheckResult = { isAllowed: boolean; isExceeded: boolean; availableAmount: number; allocatedAmount: number; committedAmount: number; actualAmount: number; requestedAmount: number; warningMessage?: string | null; blockWhenExceeded: boolean }
export type BudgetTransaction = { id: string; tenantId: string; budgetId: string; businessType: string; businessId: string; businessNumber: string; transactionType: string; amount: number; balanceAfter: number; description?: string | null; operatorId: string; createdAt: string }
