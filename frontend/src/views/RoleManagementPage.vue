...
const form = reactive({ code: '', name: '', permissions: [] as string[], leaveDataScope: 'SELF' as DataScope, expenseDataScope: 'SELF' as DataScope, travelDataScope: 'SELF' as DataScope, personnelDataScope: 'SELF' as DataScope, attendanceDataScope: 'SELF' as DataScope, contractDataScope: 'SELF' as DataScope })
...
function openCreate() {
  editing.value = false
  Object.assign(form, { code: '', name: '', permissions: [], leaveDataScope: 'SELF', expenseDataScope: 'SELF', travelDataScope: 'SELF', personnelDataScope: 'SELF', attendanceDataScope: 'SELF', contractDataScope: 'SELF' })
...
async function saveRole() {
  ...
  const payload = { code: form.code.trim(), name: form.name.trim(), permissions: [...form.permissions], dataScopes: { Leave: form.leaveDataScope, Expense: form.expenseDataScope, Travel: form.travelDataScope, Personnel: form.personnelDataScope, Attendance: form.attendanceDataScope, Contract: form.contractDataScope } }
