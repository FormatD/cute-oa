...
const editName = ref('')
const editCode = ref('')
const editBusinessType = ref<'Leave' | 'Expense' | 'Travel' | 'Purchase'>('Leave')
...
const businessLabel = (type: string) => type === 'Leave' ? '请假' : type === 'Expense' ? '报销' : type === 'Travel' ? '出差' : '采购'
