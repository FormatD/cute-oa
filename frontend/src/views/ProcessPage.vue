...
const editName = ref('')
const editCode = ref('')
const editBusinessType = ref<'Leave' | 'Expense' | 'Travel'>('Leave')
...
const businessLabel = (type: string) => type === 'Leave' ? '请假' : type === 'Expense' ? '报销' : '出差'
