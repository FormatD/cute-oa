...
const pageName = computed(() => ({ workbench: '工作台', announcements: '公司公告', 'announcement-admin': '公告管理', leave: '请假管理', expense: '费用报销', travel: '出差管理', approval: '审批中心', copies: '待我阅读', delegations: '审批委托', hr: '人事档案', 'personnel-cases': '员工办理', contracts: '劳动合同', attendance: '考勤管理', organization: '组织通讯录', departments: '组织架构', positions: '岗位管理', calendar: '工作日历', users: '用户与权限', roles: '角色与权限', audit: '审计日志', processes: '流程定义', security: '登录设备' }[props.activeNav] ?? '工作台'))
