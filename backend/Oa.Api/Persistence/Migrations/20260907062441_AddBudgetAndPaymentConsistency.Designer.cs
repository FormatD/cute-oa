...
namespace Oa.Api.Persistence.Migrations
{
    ...
    [Migration("20260907062441_AddBudgetAndPaymentConsistency")]
    partial class AddBudgetAndPaymentConsistency
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Oa.Api.Domain.DocumentAcknowledgementRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "DocumentId", "DocumentVersion", "UserId")
                        .IsUnique();

                    b.ToTable("document_acknowledgement", (string)null);
                });

            modelBuilder.Entity("Oa.Api.Domain.DocumentCategoryRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Oa.Api.Domain.DocumentVersionRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Oa.Api.Domain.KnowledgeDocumentRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Oa.Api.Persistence.AttendanceAppealRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("attendance_appeal", (string)null);
                });

            modelBuilder.Entity("Oa.Api.Persistence.AttendanceMonthLockRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("UnlockedByName")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
            ...
            modelBuilder.Entity("Oa.Api.Persistence.AttendanceRecordEntity", b =>
                {
                    ...
                    b.HasIndex("TenantId", "WorkDate", "Status", "UserId");

                    b.ToTable("attendance_record", (string)null);
                });

            modelBuilder.Entity("Oa.Api.Persistence.AttendanceShiftRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("attendance_shift", (string)null);
                });
            ...
            modelBuilder.Entity("Oa.Api.Persistence.BudgetRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "DepartmentId", "Year", "Month", "Status");

                    b.HasIndex("TenantId", "DepartmentId", "ExpenseCategory", "ProjectId", "Year", "Month")
                        .IsUnique();

                    b.ToTable("budget", (string)null);
                });

            modelBuilder.Entity("Oa.Api.Persistence.BudgetTransactionRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "ActionKey")
                        .IsUnique()
                        .HasDatabaseName("UX_budget_transaction_action_key")
                        .HasFilter("\"ActionKey\" IS NOT NULL");

                    b.HasIndex("TenantId", "BusinessType", "BusinessId");

                    b.ToTable("budget_transaction", (string)null);
                });
            ...
            modelBuilder.Entity("Oa.Api.Persistence.CompTimeGrantRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "UserId", "ExpiredAt");

                    b.ToTable("comp_time_grant", (string)null);
                });
            ...
            modelBuilder.Entity("Oa.Api.Persistence.ContractAlertAcknowledgementRecord", b =>
                {
                    ...
                    b.HasIndex("ContractId", "ThresholdDays")
                        .IsUnique();

                    b.HasIndex("TenantId", "AcknowledgedAt");

                    b.ToTable("contract_alert_ack", (string)null);
                });

            modelBuilder.Entity("Oa.Api.Persistence.ContractAlertDeliveryRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ContractId", "RecipientId", "ThresholdDays")
                        .IsUnique();

                    b.ToTable("contract_alert_delivery", (string)null);
                });
            ...
            modelBuilder.Entity("Oa.Api.Persistence.EmploymentContractEventRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "ContractId", "CreatedAt");

                    b.ToTable("employment_contract_event", (string)null);
                });

            modelBuilder.Entity("Oa.Api.Persistence.EmploymentContractRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("OpenEndedReviewReason")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<bool>("OpenEndedReviewRequired")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("TenantId", "UserId", "Status", "EndDate");

                    b.ToTable("employment_contract", (string)null);
                });

            modelBuilder.Entity("Oa.Api.Persistence.ExpenseInvoiceRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "InvoiceFingerprint")
                        .IsUnique()
                        .HasDatabaseName("UX_expense_invoice_active_fingerprint")
                        .HasFilter("\"Status\" IN ('COMMITTED', 'PAID')");

                    b.HasIndex("TenantId", "BillingDate", "InvoiceType");

                    b.HasIndex("TenantId", "InvoiceFingerprint", "Status");
            ...
            modelBuilder.Entity("Oa.Api.Persistence.FlowSlaAlertDeliveryRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("FlowTaskSlaId");

                    b.HasIndex("TenantId", "TaskId", "RecipientId", "AlertType")
                        .IsUnique();

                    b.ToTable("flow_sla_alert_delivery", (string)null);
                });
            ...
            modelBuilder.Entity("Oa.Api.Persistence.FlowTaskSlaRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "CompletedAt", "CancelledAt", "DueAt");

                    b.ToTable("flow_task_sla", (string)null);
                });
            ...
            modelBuilder.Entity("Oa.Api.Persistence.LeaveRecord", b =>
                {
                    ...
                    b.Property<string>("CompTimeAllocationsJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValue("[]");
            ...
            modelBuilder.Entity("Oa.Api.Persistence.PaymentTransactionRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "BusinessType", "BusinessId", "Sequence")
                        .IsUnique()
                        .HasDatabaseName("UX_payment_transaction_sequence");
            ...
            modelBuilder.Entity("Oa.Api.Persistence.ProcessNodeRecord", b =>
                {
                    ...
                    b.Property<string>("MissingAssigneeAction")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
            ...
            modelBuilder.Entity("Oa.Api.Persistence.PurchaseRequestRecord", b =>
                {
                    ...
                    b.Property<string>("AcceptanceRoleOrAssignee")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<string>("AmountTier")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.Property<decimal>("PrepaymentLimitRate")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(6, 4)
                        .HasColumnType("numeric(6,4)")
            ...
            modelBuilder.Entity("Oa.Api.Persistence.SealExecutionRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SealRequestId")
                        .IsUnique();

                    b.ToTable("seal_execution", (string)null);
                });
            ...
            modelBuilder.Entity("Oa.Api.Persistence.SealRequestRecord", b =>
                {
                    ...
                    b.Property<string>("OutCustodian")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<DateOnly?>("OutEndDate")
                        .HasColumnType("date");

                    b.Property<DateOnly?>("OutStartDate")
                        .HasColumnType("date");
                    ...
                    b.ToTable("seal_request", (string)null);
                });

            modelBuilder.Entity("Oa.Api.Persistence.SealReturnRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SealCondition")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
                    ...
                    b.ToTable("seal_return", (string)null);
                });

            modelBuilder.Entity("Oa.Api.Persistence.SealTaskRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("seal_task", (string)null);
                });
            ...
            modelBuilder.Entity("Oa.Api.Persistence.TravelRecord", b =>
                {
                    ...
                    b.Property<bool>("IsOverStandard")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("OverStandardReason")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<string>("PrimaryCityTier")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
                    ...
                    b.Property<decimal>("StandardHotelDailyLimit")
                        .HasPrecision(14, 2)
                        .HasColumnType("numeric(14,2)");

                    b.Property<decimal>("StandardMealDailyAllowance")
                        .HasPrecision(14, 2)
                        .HasColumnType("numeric(14,2)");

                    b.Property<string>("StandardTransportation")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
            ...
            modelBuilder.Entity("Oa.Api.Domain.DocumentAcknowledgementRecord", b =>
                {
                    b.HasOne("Oa.Api.Domain.KnowledgeDocumentRecord", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Oa.Api.Domain.KnowledgeDocumentRecord", b =>
                {
                    b.HasOne("Oa.Api.Domain.DocumentCategoryRecord", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Oa.Api.Persistence.AttendanceAppealRecord", b =>
                {
                    b.HasOne("Oa.Api.Persistence.AttendanceRecordEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Oa.Api.Persistence.BudgetTransactionRecord", b =>
                {
                    b.HasOne("Oa.Api.Persistence.BudgetRecord", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Oa.Api.Persistence.ContractAlertAcknowledgementRecord", b =>
                {
                    b.HasOne("Oa.Api.Persistence.EmploymentContractRecord", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Oa.Api.Persistence.FlowSlaAlertDeliveryRecord", b =>
                {
                    b.HasOne("Oa.Api.Persistence.FlowTaskSlaRecord", null)
                        .WithMany()
                        .HasForeignKey("FlowTaskSlaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Oa.Api.Persistence.SealExecutionRecord", b =>
                {
                    b.HasOne("Oa.Api.Persistence.SealRequestRecord", null)
                        .WithOne()
                        .HasForeignKey("Oa.Api.Persistence.SealExecutionRecord", "SealRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Oa.Api.Persistence.SealReturnRecord", b =>
                {
                    b.HasOne("Oa.Api.Persistence.SealRequestRecord", null)
                        .WithOne()
                        .HasForeignKey("Oa.Api.Persistence.SealReturnRecord", "SealRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
