...
public sealed record ManagedUserView(string Id, string Name, string DepartmentId, string DepartmentName, string? ManagerId, string? ManagerName, int CumulativeWorkYears, string Status, int Version, IReadOnlyList<string> Roles, IReadOnlyList<string> Permissions, DateTimeOffset CreatedAt, DateTimeOffset UpdatedAt, string? PositionId = null, string? PositionName = null);
public sealed record CreateManagedUserRequest(string Id, string Name, string DepartmentId, string? ManagerId, int CumulativeWorkYears, IReadOnlyList<string> Roles, string Password, string? PositionId = null);
