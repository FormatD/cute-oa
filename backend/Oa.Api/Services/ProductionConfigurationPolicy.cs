...
public static class ProductionConfigurationPolicy
{
    ...
    private static void ValidateAuthentication(IConfiguration configuration, ICollection<string> errors)
    {
        ...
        foreach (var permission in new[] { OaPermissions.UserManage, OaPermissions.PersonnelExport, OaPermissions.PersonnelManage, OaPermissions.AttendanceManage, OaPermissions.ContractManage, OaPermissions.PurchaseManage, OaPermissions.SealManage }.Where(permission => !requiredPermissions.Contains(permission)))
